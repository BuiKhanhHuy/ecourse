...
SECRET_KEY = 'django-insecure-q!(ku+^9ylm3w1+e$u4jz6l8&okskn^)^7==5+g11!)+ehyd&8'
...
JAZZMIN_SETTINGS = {
    "site_logo": "site/logo/site-icon.png",
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/BuiKhanhHuy",
         "new_window": True},
    ],
    # Additional links to include in the user menu on the top right ("app" url type is not allowed)
    "usermenu_links": [
        {"name": "Support", "url": "https://github.com/BuiKhanhHuy", "new_window": True},
        {"model": "auth.user"}
    ],
